...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xfc54961b, 0xf74c, 0x4700, {0xa8, 0xca, 0x20, 0x4c, 0xea, 0x15, 0x06, 0x81}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0x20c0491a, 0x6a8b, 0x4837, {0xb3, 0x0d, 0x6a, 0x29, 0xab, 0x35, 0xc1, 0x4b}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SigmaBootPkg";
